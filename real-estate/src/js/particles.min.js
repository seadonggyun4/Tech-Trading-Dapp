...
var Particles = function (e, t) {
    ...
    n.prototype._initializeCanvas = function () {
        ...
        if (!o.options.selector) 
            return console.warn(
                "particles.js: No selector specified! Check https://github.com/marcbruederlin/p" +
                "articles.js#options"
            ),
            !1;
    ...
    n.prototype._initializeStorage = function () {
        ...
        for (var t = e.options.maxParticles; t--;) 
            e
                .storage
                .push(new i(e.context, e.options))
        },
        ...
        if ("object" == typeof o && null !== o && o.length) {
            for (e in o) 
                if (n = i.breakpoints.length - 1, t = o[e].breakpoint, o.hasOwnProperty(e)) {
                    for (; n >= 0;) 
                        i.breakpoints[n] && i.breakpoints[n] === t && i
                            .breakpoints
                            .splice(n, 1),
                        n--;
                    i
    ...
    n.prototype._checkResponsive = function () {
        ...
        if (n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
            for (t in i = null, n.breakpoints) 
                n
                    .breakpoints
                    .hasOwnProperty(t) && o <= n
                    .breakpoints[t] && (i = n.breakpoints[t]);
            null !== i
                ? (
    ...
    n.prototype._animate = function () {
        var t = this;
        t._draw(),
        t._animation = e.requestAnimFrame(t._animate)
    },
    ...
    n.prototype.pauseAnimation = function () {
        ...
        n.prototype._drawEdge = function (e, t, n) {
            var i = this,
                o = i
                    .context
                    .createLinearGradient(e.x, e.y, t.x, t.y),
        ...
        (i = function (n, i) {
            ...
            e
                .context
                .arc(0, 0, e.radius, 0, 2 * Math.PI, !1),
